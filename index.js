    ...
    class MEME_CHAT{
      ...
      create_chat(){
       ...
       //HAHHAAHAHAHAHHAHAHAHAHHAHAHHAHAHAHAHHAHAHAHHAHAHHA//
         // Create a greeting message based on the person's nickname
        var greeting = `Hello ${this.get_name()}!`;

          // Create the greeting element and set its attributes
          var greetingContainer = document.createElement('div');
          greetingContainer.setAttribute('id', 'greeting_container');

          var greetingText = document.createElement('p');
          greetingText.setAttribute('id', 'greeting_text');
          greetingText.textContent = greeting;

          // Append the greeting element to the chat container
          greetingContainer.append(greetingText);
          chat_inner_container.prepend(greetingContainer); // Add the greeting element at the top of the chat container
      }
